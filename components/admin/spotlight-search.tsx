    ...
    mounted && open
      ? createPortal(
          <div className="fixed inset-0 z-[120] flex items-start justify-center px-4 pt-32">
            ...
            />
            <div
              className="relative z-[121] w-full max-w-3xl rounded-2xl border bg-background shadow-2xl ring-1 ring-border/50"
            ...
            >
              <div className="p-2">
                ...
                {filteredSections.length > 0 && (
                  <div className="mt-2 max-h-[400px] overflow-y-auto border-t">
                    <div className="py-2">
                ...
                {query.trim() && filteredSections.length === 0 && (
                  <div className="mt-2 border-t py-8 text-center">
